...
### ⭐ Opção 0: Menu Interativo (MAIS FÁCIL!)
...
- Volte ao menu a qualquer momento
- Sem complicações!

---

### ⭐ Opção 0b: Tudo Automático (Rápido)

**Windows:**
```
Duplo clique em: iniciar_servidores.bat
```
...
**Resultado:**
- ✅ Servidor de dados (Node.js) inicia
- ✅ Servidor web (Python) inicia
...
| Opcao | Servidor | Rede | Sincronização | Facilidade |
|-------|----------|------|---|---|
| **Menu Interativo** | ✅ Escolha | ✅ Sim | ✅ Sim | ⭐⭐⭐⭐⭐ |
| **Tudo Automático** | ✅ Sim | ✅ Sim | ✅ SIM | ⭐⭐⭐⭐⭐ |
| Live Server | ✅ Sim | ❌ Não | ❌ Não | ⭐⭐⭐⭐⭐ |
| Python (localhost) | ✅ Sim | ❌ Não | ❌ Não | ⭐⭐⭐ |
| Python (0.0.0.0) | ✅ Sim | ✅ Sim | ❌ Não | ⭐⭐⭐ |
| VSCode Terminal | ✅ Sim | ✅ Sim | ❌ Não | ⭐⭐⭐⭐ |
...
**Novo: Sincronização com Servidor Node.js** 🚀
- **Servidor centralizado** - Compartilha dados entre todos os dispositivos
- **Arquivo permanente** - Dados salvos em `data/ipial_data.json`
- **Sincronização automática** - A cada 30 segundos
- **Funciona offline** - localStorage como fallback se servidor cair

⚠️ **Como funciona:**
- Dados persistem após fechar o navegador (localStorage)
- Se servidor Node.js estiver rodando, sincroniza com arquivo JSON
- Múltiplos dispositivos/celulares compartilham os MESMOS dados em tempo real
- Faca **backup regular** usando "Exportar JSON" na secção Publicacoes ou copiando `data/ipial_data.json`

👉 **Para ativar sincronização, veja:** [SERVIDOR_SINCRONIZACAO.md](SERVIDOR_SINCRONIZACAO.md)
...
- **[⚡ QUICKSTART.md](QUICKSTART.md)** - Iniciar em 10 segundos (COMECE AQUI!)
...
- **[SERVIDOR_SINCRONIZACAO.md](SERVIDOR_SINCRONIZACAO.md)** - Setup completo do servidor Node.js
